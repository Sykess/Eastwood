...
public class Server {
     ...
     */
    private synchronized void broadcast(String message, String recip, String sender) {
        // add HH:mm:ss and \n to the message
    ...
    class ClientThread extends Thread {
        ...
        public void run() {
            ...
            while(keepGoing) {
                ...
                String sender = cm.getUser();

                // Switch on the type of message receive
                switch(cm.getType()) {

                case ChatMessage.MESSAGE:
                    broadcast(username + ": " + message, recipient, sender);
                    break;
