...
public class CaronNateBS
{
	public static void main(String[] args)
	{
		...
		int[] array = {1356, 152, 151, 155, 1350, 200000000,
					   151, 45, 1355, 669575, 9392, 11, 11};
		int[] array2 = new int[10];

		for(int i = 0; i < array2.length; i++)
			array2[i] = gen.nextInt(1000);
		sort(array);
		sort(array2);

		System.out.println("Sorted premade array: ");
		for(int x : array)
			System.out.println(x);

		System.out.println("\nSorted randomly generated array: ");
		for(int x : array2)
			System.out.println(x);
	}
///////////////////////////////////////////////////////////////////////
